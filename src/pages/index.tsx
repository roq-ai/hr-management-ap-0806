  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Streamline Your Workforce Strategy with HR Management Application - Your Ultimate Tool for Employee Engagement, Performance Tracking, and Organizational Growth"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Streamline Your Workforce Strategy with HR Management Application - Your Ultimate Tool for Employee Engagement, Performance Tracking, and Organizational Growth`}
            </Text>
            <Box
